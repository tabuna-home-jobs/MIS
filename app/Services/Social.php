...
class Social {
    ...
    public function pushFB()
    {
        ...
        $APP_ID = Options::select('value')->whereRaw('ids = ? and module=? ',[Session::get('website'), 'fb-app-id'])->first();
        $APP_SECRET = Options::select('value')->whereRaw('ids = ? and module=? ',[Session::get('website'), 'fb-app-secret'])->first();
        $TOKEN =  Options::select('value')->whereRaw('ids = ? and module=? ',[Session::get('website'), 'fb-token'])->first();
