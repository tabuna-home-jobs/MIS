...
class AppointmentController extends Controller
{
     ...
     * @return Response
     */
    public function getIndex($sitename = "cozn48", $sitedomen = "ru")
    {
        //Получить все места
    ...
    public function postSpecial($place, $sitename = "cozn48", $sitedomen = "ru")
    {
    ...
    public function postFio($specialization, $sitename = "cozn48", $sitedomen = "ru")
    {
    ...
    public function postTime($place, $specialization, $fio, $sitename = "cozn48", $sitedomen = "ru")
    {
    ...
    public function postPlace($specialization, $fio, $sitename = "cozn48", $sitedomen = "ru")
    {
