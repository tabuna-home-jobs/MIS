...
class AuthController extends Controller
{
     ...
     * @return Response
     */
    public function getLogin($sitename = 'mother-baby', $sitedomen = 'ru')
    {
        if (Sentry::check()) {
            return redirect('/cabinet');
        } else {
            //$getSites = Sites::where('domen', '=', $sitename . "." . $sitedomen)->first();
            return view( $sitename . $sitedomen . '/auth/login', []);
        }
    }
    ...
    public function getRegister($sitename = 'mother-baby', $sitedomen = 'ru')
    {
        if (Sentry::check()) {
            return redirect('/cabinet');
        } else {
            return view( $sitename . $sitedomen . '/auth/register');
        }
    }


    public function postRegister(AuthRequest $request, $sitename = 'mother-baby', $sitedomen = 'ru')
    {
        if (Sentry::check()) {
            return redirect('/cabinet');
        } else {
    ...
    public function getLogout($sitename = 'mother-baby', $sitedomen = 'ru')
    {
        Sentry::logout();
        return view($sitename . $sitedomen . '/auth/login', []);
    }
    ...
    public function getAction($email = null, $activationCode = null, $sitename = 'mother-baby', $sitedomen = 'ru')
    {
        ...
        if (Sentry::check()) {
            ...
            if (is_null($email) || is_null($activationCode)) {
                return view($sitename . $sitedomen . '/auth/action', ['email' => $email]);
            } else {
    ...
    public function getRepeat($sitename = 'mother-baby', $sitedomen = 'ru')
    {
        if (Sentry::check()) {
            return redirect('/cabinet');
        } else {

            return view( $sitename . $sitedomen . '/auth/repeat');
        }
    }

    public function postRepeat(RepeatRequest $request, $sitename = 'mother-baby', $sitedomen = 'ru')
    {
        if (Sentry::check()) {
            return redirect('/cabinet');
        } else {
            ...
            return redirect( $sitename . $sitedomen . '/auth/action');
        }
    }
}
