...
class AppointmentController extends Controller
{
    ...
    public function postSpecial($place, $sitename = 'mother-baby', $sitedomen = 'ru')
    {
    ...
    public function postFio($specialization, $sitename = 'mother-baby', $sitedomen = 'ru')
    {
    ...
    public function postTime($place, $specialization, $fio, $sitename = 'mother-baby', $sitedomen = 'ru')
    {
    ...
    public function postPlace($specialization, $fio, $sitename = 'mother-baby', $sitedomen = 'ru')
    {
