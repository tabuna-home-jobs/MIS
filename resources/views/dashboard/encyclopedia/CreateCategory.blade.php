            ...
            <div class='col-md-12'>
                ...
                <div class='box'>
                    ...
                    <div class='box-body pad'>
                        ...
                        <form action="/dashboard/encyclopediaCategory" method="post" class="row" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-tag" data-role="tagsinput" type="text"
                                           maxlength="255" required name="tag">
                                </div>
                                <div class="form-group">
                                    <label>Описание</label>
                                    <textarea class="form-control" maxlength="255" rows="7" required name="descript"></textarea>
                                </div>
