    ...
    <div class="wrapper-md">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <a href="{{URL::route('dashboard.user.create')}}" class="btn btn-success btn-xs pull-right">Добавить <i
            ...
            <div class="row">
                <div class="col-sm-6 text-center">
                    <small class="text-muted inline m-t-sm m-b-sm">Всего элементов: {!! $Users->count() !!}</small>
                </div>
