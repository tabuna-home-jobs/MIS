...
<div id="wrapper">
        ...
        <div class="container">
            <nav class="navbar navbar-default" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="/site1.ru/images/logo.png" alt="image" title="Medicom Logo"></a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="mega-menu-item"><a href="medical-department.html">DEPARTMENTS</a>
                            <div class="mega-menu">
                                <img src="/site1.ru/images/mega-menu-img.jpg" class="img-rounded" alt="" title="">
                                <ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 blog-wrapper clearfix">
                    <h2 class="bordered light">Blog <span>Single Post</span></h2>
                    ...
                    @foreach($News as $key => $value)
                        ...
                        <article class="blog-item blog-full-width">
                            ...
                            <div class="blog-content">
                                ...
                                {!! $value['content'] !!}
                                <a href="#." class="btn btn-default btn-mini btn-rounded">Читать</a>
                            </div>
                        </article>
                ...
                <aside class="col-md-4">
                    ...
                    <div class="sidebar-widget light">
                        ...
                        <article class="popular-post">
                            <img src="/site1.ru/images/recent-post-img1.jpg" alt="">
                            <h4><a href="#.">Geometric Landscapes Heartologic</a></h4>
                            <p class="popular-date">3 months ago</p>
                        </article>
                        <article class="popular-post">
                            <img src="/site1.ru/images/recent-post-img2.jpg" alt="">
                            <h4><a href="#.">Day care Landscapes Eyeologic</a></h4>
                            <p class="popular-date">5 months ago</p>
                        </article>
                        <article class="popular-post">
                            <img src="/site1.ru/images/recent-post-img3.jpg" alt="">
                            <h4><a href="#.">Premium Wordpress for your clinic</a></h4>
                            <p class="popular-date">8 months ago</p>
                        </article>
                    </div>

                    <div class="sidebar-widget clearfix">
                        <h2 class="bordered light">Archives</h2>
                        <ul class="archives">
                            <li><a href="#."><i class="fa fa-long-arrow-right"></i>December 2013</a></li>
                            <li><a href="#."><i class="fa fa-long-arrow-right"></i>November 2013</a></li>
                            <li><a href="#."><i class="fa fa-long-arrow-right"></i>May 2012</a></li>
                            <li><a href="#."><i class="fa fa-long-arrow-right"></i>June 2013</a></li>
                            <li><a href="#."><i class="fa fa-long-arrow-right"></i>February 2013</a></li>
                            <li><a href="#."><i class="fa fa-long-arrow-right"></i>October 2012</a></li>
                            <li><a href="#."><i class="fa fa-long-arrow-right"></i>August 2012</a></li>
                            <li><a href="#."><i class="fa fa-long-arrow-right"></i>July 2013</a></li>
                        </ul>
                    </div>
                    <div class="sidebar-widget clearfix">
    ...
    <footer id="footer" class="light">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-2"><a href="#."><img src="/site1.ru/images/footer-logo.jpg" alt="" title="Medicom Logo"></a></div>
                <div class="col-md-10">
...
<script src="/site1.ru/js/jquery.js"></script>
