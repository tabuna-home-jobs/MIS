                            ...
                            <div class="wpb_column vc_column_container vc_col-sm-12">
                                <div class="wpb_wrapper">
                                    <div class="wpcf7" id="wpcf7-f272-p254-o1" lang="en-US" dir="ltr">
                                        ...
                                        <form name="" action="/cupid/contact-us/#wpcf7-f272-p254-o1" method="post"
                                              class="wpcf7-form" novalidate="novalidate">
                                            <div style="display: none;"><input type="hidden" name="_wpcf7" value="272">
                                                <input type="hidden" name="_wpcf7_version" value="4.0.2"> <input
                                                        type="hidden" name="_wpcf7_locale" value="en_US"> <input
                                                        type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f272-p254-o1">
                                            ...
                                            <div class="row contact-form-contact-us row bg-while">
                                                ...
                                                <div class="col-md-10 col-sm-12 contact-form-contact-us-right">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-12 contact-form-input"><span
                                                                    class="wpcf7-form-control-wrap your-name"><input
                                                                        type="text" name="your-name" value="" size="40"
                                                                        class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"
                                                                        id="your-name" aria-required="true"
                                                                        aria-invalid="false" placeholder="ФИО*"></span>
                                                        </div>
                                                        <div class="col-md-6 col-sm-12 contact-form-input"><span
                                                                    class="wpcf7-form-control-wrap your-email"><input
                                                                        ...
                                                                        id="your-email" aria-required="true"
                                                                        aria-invalid="false"
                                                                        placeholder="Email*"></span></div>


                                                        <div class="col-md-12 col-sm-12 contact-form-input"><span
                                                                    class="wpcf7-form-control-wrap your-email"><input
                                                                        type="email" name="your-email" value=""
                                                                        size="40"
                                                                        class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email"
                                                                        id="your-email" aria-required="true"
                                                                        aria-invalid="false"
                                                                        placeholder="Телефон*"></span></div>



                                                        <div class="col-md-12 col-sm-12 contact-form-input"><span
                                                                    class="wpcf7-form-control-wrap your-message"><textarea
                                                                        name="your-message" cols="4" rows="10"
                                                                        class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required"
                                                                        id="your-message" aria-required="true"
                                                                        aria-invalid="false"
                                                                        placeholder="Ваше сообщение...*"></textarea></span>
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 contact-form-submit"><input
                                                                    type="submit" value="Отправить"
                                                                    class="wpcf7-form-control wpcf7-submit cupid-button button-sm"
                                                                    id="submit"><img class="ajax-loader"
                                                                                     src="http://themes.g5plus.net/cupid/wp-content/plugins/contact-form-7/images/ajax-loader.gif"
                                                                                     alt="Sending ..."
