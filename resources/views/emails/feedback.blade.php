                                                ...
                                                <td valign='top' align='center'>
                                                    <div class="contentEditableContainer contentImageEditable">
                                                        <div class="contentEditable">
                                                            <img src="http://zdorovie48.ru/site1.ru/images/logo.png" width='228' height='119' alt='' data-default="placeholder" data-max-width="560">
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                                ...
                                                <td align='left'>
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='center'>
                                                            <h2>Запрос от посетителя веб-сайта</h2>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                                                ...
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align='center'>
                                                                        <p  style='text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;'>
                                                                            <span style='font-weight:bold;'>"Здоровье Нации"</span>
                                                                            <br>
                                                                            г.Липецк ул.Октябрьская д.61
                                                                            <br>
                                                                            (4742) 227-887
                                                                            <br>
                                                                            <a  target='_blank' href="http://zdorovie48.ru">zdorovie48.ru</a>
                                                                         </p>
                                                                    </div>
                                                                </div>
                                                            </td>
