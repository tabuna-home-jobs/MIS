        ...
        <div class="container text-center">
            <div class="w-full">
                <div class="col-md-4 padder-v">
                    <a href="#" class="block"> <p class="h3 m-b-md"><span class="text-muted-dm b-b-success">Консультации</span></p>
                        <i class="fa fa-user-md fa-8x text-primary" aria-hidden="true"></i>
                    </a>
                </div>
                <div class="col-md-4 padder-v">
                    <a href="#" class="block"><p class="h3 m-b-md"><span class="text-muted-dm b-b-success">Консультации</span></p></a>
